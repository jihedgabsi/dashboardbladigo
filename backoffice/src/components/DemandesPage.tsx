...
const DemandesPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://vokkkokcowo0wgsok88844wo.82.112.242.233.sslip.io/api/demandes-transport');
  ...
  const deleteDemande = async (id) => {
    ...
    try {
      const response = await fetch(`http://vokkkokcowo0wgsok88844wo.82.112.242.233.sslip.io/api/demandes-transport/${id}`, {
        method: 'DELETE',
      });
  ...
  const updateDemande = async () => {
    try {
      const response = await fetch(`http://vokkkokcowo0wgsok88844wo.82.112.242.233.sslip.io/api/demandes-transport/${editingDemande._id}`, {
        method: 'PUT',
        headers: {
      ...
      if (response.ok) {
        ...
        const allDemandesResponse = await fetch('http://vokkkokcowo0wgsok88844wo.82.112.242.233.sslip.io/api/demandes-transport');
